import CJS_COMPAT_NODE_URL_v7v1hgio5wh from 'node:url';
import CJS_COMPAT_NODE_PATH_v7v1hgio5wh from 'node:path';
import CJS_COMPAT_NODE_MODULE_v7v1hgio5wh from "node:module";

var __filename = CJS_COMPAT_NODE_URL_v7v1hgio5wh.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_v7v1hgio5wh.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_v7v1hgio5wh.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-MCXIA3AZ.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-PVAFW5M5.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-6JM2KRWM.js";
import {
  detectPnp
} from "../_node-chunks/chunk-XZXFI24H.js";
import "../_node-chunks/chunk-WHUDIW75.js";
import {
  StorybookError
} from "../_node-chunks/chunk-IXRAZWYK.js";
import {
  telemetry
} from "../_node-chunks/chunk-NBISOXOA.js";
import "../_node-chunks/chunk-BJ2APMQT.js";
import {
...
} from "../_node-chunks/chunk-4LW64M4K.js";
import "../_node-chunks/chunk-FKTICHSE.js";
import "../_node-chunks/chunk-6CW3SSYD.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-A7TTKY27.js";
import "../_node-chunks/chunk-QXOYAPRH.js";
import "../_node-chunks/chunk-ZXMSD5LF.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-EUDHHQM6.js";
import "../_node-chunks/chunk-JQKXBJ6J.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-DXD47XSI.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-FMFOFX2R.js";
import {
  slash
} from "../_node-chunks/chunk-2DDWN57W.js";
import "../_node-chunks/chunk-L5XV7LN2.js";
import {
  Tag
} from "../_node-chunks/chunk-7ET2D7PV.js";
import {
  require_dist
} from "../_node-chunks/chunk-YULXQSLY.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-B5HLXFVN.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-V56HH6KE.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-TJ4EK3NZ.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-V3W7PNEB.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-OI2APPNR.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-M4NWA2ID.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-OI2APPNR.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
